...
//NewCommitteeMemberUpdateGlobalParametersOperation creates a new CommitteeMemberUpdateGlobalParametersOperation
func NewCommitteeMemberUpdateGlobalParametersOperation() *CommitteeMemberUpdateGlobalParametersOperation {
	tx := CommitteeMemberUpdateGlobalParametersOperation{}
	return &tx
}
