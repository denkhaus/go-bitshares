...
handle_Seller:
	...
	/* handler: j.Seller type=objects.GrapheneID kind=struct quoted=false*/
...
handle_AmountToSell:
	...
	/* handler: j.AmountToSell type=objects.AssetAmount kind=struct quoted=false*/
...
handle_MinToReceive:
	...
	/* handler: j.MinToReceive type=objects.AssetAmount kind=struct quoted=false*/
...
handle_Extensions:
...

	{
		...
		if tok == fflib.FFTok_null {
			...
			j.Extensions = []objects.Extension{}

			wantVal := true

			for {

				var tmpJExtensions objects.Extension
