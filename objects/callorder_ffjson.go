...
handle_Borrower:
	...
	/* handler: j.Borrower type=objects.GrapheneID kind=struct quoted=false*/
...
handle_Collateral:
	...
	/* handler: j.Collateral type=objects.UInt64 kind=uint64 quoted=false*/
...
handle_Debt:
	...
	/* handler: j.Debt type=objects.UInt64 kind=uint64 quoted=false*/
...
handle_CallPrice:
	...
	/* handler: j.CallPrice type=objects.Price kind=struct quoted=false*/
