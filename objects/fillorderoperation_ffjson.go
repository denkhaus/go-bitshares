...
handle_OrderID:
	...
	/* handler: j.OrderID type=objects.GrapheneID kind=struct quoted=false*/
...
handle_AccountID:
	...
	/* handler: j.AccountID type=objects.GrapheneID kind=struct quoted=false*/
...
handle_Pays:
	...
	/* handler: j.Pays type=objects.AssetAmount kind=struct quoted=false*/
...
handle_Receives:
	...
	/* handler: j.Receives type=objects.AssetAmount kind=struct quoted=false*/
...
handle_FillPrice:
	...
	/* handler: j.FillPrice type=objects.Price kind=struct quoted=false*/
