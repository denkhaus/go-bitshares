...
handle_DynamicAssetDataID:
	...
	/* handler: j.DynamicAssetDataID type=objects.GrapheneID kind=struct quoted=false*/
...
handle_BitassetDataID:
	...
	/* handler: j.BitassetDataID type=objects.GrapheneID kind=struct quoted=false*/
