...
handle_Publisher:
	...
	/* handler: j.Publisher type=objects.GrapheneID kind=struct quoted=false*/
...
handle_AssetID:
	...
	/* handler: j.AssetID type=objects.GrapheneID kind=struct quoted=false*/
...
handle_Feed:
	...
	/* handler: j.Feed type=objects.AssetFeedInfo kind=struct quoted=false*/
