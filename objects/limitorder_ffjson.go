...
handle_ForSale:
	...
	/* handler: j.ForSale type=objects.UInt64 kind=uint64 quoted=false*/
...
handle_DeferredFee:
	...
	/* handler: j.DeferredFee type=objects.UInt64 kind=uint64 quoted=false*/
...
handle_SellPrice:
	...
	/* handler: j.SellPrice type=objects.Price kind=struct quoted=false*/
