...
handle_WhitelistingAccounts:
	...
	/* handler: j.WhitelistingAccounts type=[]objects.GrapheneID kind=slice quoted=false*/

	{
		...
		if tok == fflib.FFTok_null {
			...
			for {
				...
				/* handler: tmpJWhitelistingAccounts type=objects.GrapheneID kind=struct quoted=false*/
...
handle_BlacklistingAccounts:
	...
	/* handler: j.BlacklistingAccounts type=[]objects.GrapheneID kind=slice quoted=false*/

	{
		...
		if tok == fflib.FFTok_null {
			...
			for {
				...
				/* handler: tmpJBlacklistingAccounts type=objects.GrapheneID kind=struct quoted=false*/
...
handle_WhitelistedAccounts:
	...
	/* handler: j.WhitelistedAccounts type=[]objects.GrapheneID kind=slice quoted=false*/

	{
		...
		if tok == fflib.FFTok_null {
			...
			for {
				...
				/* handler: tmpJWhitelistedAccounts type=objects.GrapheneID kind=struct quoted=false*/
...
handle_BlacklistedAccounts:
	...
	/* handler: j.BlacklistedAccounts type=[]objects.GrapheneID kind=slice quoted=false*/

	{
		...
		if tok == fflib.FFTok_null {
			...
			for {
				...
				/* handler: tmpJBlacklistedAccounts type=objects.GrapheneID kind=struct quoted=false*/
