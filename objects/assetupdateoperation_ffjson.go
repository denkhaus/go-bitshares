...
const (
	...
	ffjtAssetUpdateOperationOptions
)
...
var ffjKeyAssetUpdateOperationOptions = []byte("new_options")
	...
	for {
		...
		case fflib.FFParse_want_key:
			...
			if len(kn) <= 0 {
				...
				case 'n':
					...
					if bytes.Equal(ffjKeyAssetUpdateOperationOptions, kn) {
						currentKey = ffjtAssetUpdateOperationOptions
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				if fflib.EqualFoldRight(ffjKeyAssetUpdateOperationOptions, kn) {
					currentKey = ffjtAssetUpdateOperationOptions
					state = fflib.FFParse_want_colon
					goto mainparse
				}
		...
		case fflib.FFParse_want_value:
			...
			if tok == fflib.FFTok_left_brace || tok == fflib.FFTok_left_bracket || tok == fflib.FFTok_integer || tok == fflib.FFTok_double || tok == fflib.FFTok_string || tok == fflib.FFTok_bool || tok == fflib.FFTok_null {
				...
				case ffjtAssetUpdateOperationOptions:
					goto handle_Options
...
handle_AssetToUpdate:
	...
	/* handler: j.AssetToUpdate type=objects.GrapheneID kind=struct quoted=false*/
...
handle_Options:
	...
	/* handler: j.Options type=objects.AssetOptions kind=struct quoted=false*/

	{
		/* Falling back. type=objects.AssetOptions kind=struct */
		tbuf, err := fs.CaptureField(tok)
		if err != nil {
			return fs.WrapErr(err)
		}
