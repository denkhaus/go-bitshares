...
func (j *OperationHistory) MarshalJSONBuf(buf fflib.EncodingBuffer) error {
	...
	/* Interface types must use runtime reflection. type=objects.OperationResult kind=interface */
...
handle_BlockNum:
	...
	/* handler: j.BlockNum type=objects.UInt32 kind=uint32 quoted=false*/
...
handle_TrxInBlock:
	...
	/* handler: j.TrxInBlock type=objects.UInt16 kind=uint16 quoted=false*/
...
handle_OpInTrx:
	...
	/* handler: j.OpInTrx type=objects.UInt16 kind=uint16 quoted=false*/
...
handle_VirtualOp:
	...
	/* handler: j.VirtualOp type=objects.UInt16 kind=uint16 quoted=false*/
...
handle_Operation:
	...
	/* handler: j.Operation type=objects.OperationEnvelope kind=struct quoted=false*/
...
handle_Result:
	...
	/* handler: j.Result type=objects.OperationResult kind=interface quoted=false*/

	{
		/* Falling back. type=objects.OperationResult kind=interface */
		tbuf, err := fs.CaptureField(tok)
		if err != nil {
			return fs.WrapErr(err)
		}
